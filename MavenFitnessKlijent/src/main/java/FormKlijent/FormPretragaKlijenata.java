 ...
 * @author PC
 */
public class FormPretragaKlijenata extends javax.swing.JDialog {

    /**
     * Creates new form FormPretragaClanova
     */
    public FormPretragaKlijenata(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnDetalji.setText("Detalji klijenata");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((TableModelKlijenti)tblKlijent.getModel()).setParametar(param);
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if(row >= 0){
            Klijent k = 
                    ((TableModelKlijenti)tblKlijent.getModel()).getSelectedKlijent(row);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPretragaKlijenata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormPretragaKlijenata dialog = new FormPretragaKlijenata(new javax.swing.JFrame(), true);
    ...
    void refreshTable() {
        TableModelKlijenti model = (TableModelKlijenti) tblKlijent.getModel();
        model.refreshTable();
    }
}
